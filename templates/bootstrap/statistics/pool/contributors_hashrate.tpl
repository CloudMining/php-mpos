...
{section contrib $CONTRIBHASHES}
      {if $GLOBAL.config.algorithm == 'equihash'}
        {math assign="estday" equation="round( ( hashrate * 1000 ) / nethashrate * ( reward * ( 60 * 24 / 2.5 )), 4)" reward=$REWARD hashrate=$CONTRIBHASHES[contrib].hashrate nethashrate=$GLOBAL.nethashrate}
      {else}
